...
const features = [
  ...
  },
  {
    ...
    description: (
      <>
        Arank warns you when you try to install/execute dangerous stuff
        (people nowadays make plugins to hack user accounts, Arank is safe)
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Unlike many others userbots* which are being suspended by heroku, Arank doesn't get suspended.
      </>
    ),
  },
];
...
function Home() {
  ...
  return (
    <Layout
      title={`Arank Userbot`}
      description="Arank Userbot Documentation">
